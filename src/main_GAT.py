...
def get_parser():
    ...
    parser.add_argument("--dropp", type = float, default = 0.5)
...
# CosineLR = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max = 400, eta_min=1e-5)
def train():
    model.train()
